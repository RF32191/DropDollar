-- ============================================================================
-- COMPLETE MESSAGING SYSTEM - CLEAN VERSION
-- ============================================================================
-- Drops EVERYTHING first, then recreates fresh
-- ============================================================================

-- ============================================================================
-- STEP 0: Drop ALL functions first (to avoid dependency issues)
-- ============================================================================
...
DROP FUNCTION IF EXISTS public.send_message(UUID, TEXT, TEXT, JSONB) CASCADE;
DROP FUNCTION IF EXISTS public.get_or_create_conversation(UUID[], TEXT, UUID, TEXT) CASCADE;

SELECT '✅ Step 0: Dropped all functions' as status;

-- ============================================================================
-- STEP 1: Drop all tables (in correct order to respect foreign keys)
-- ============================================================================
...
SELECT '✅ Step 1: Dropped all tables' as status;
...
SELECT '
╔════════════════════════════════════════════════════════════════╗
║     ✅ MESSAGING SYSTEM CREATED (CLEAN)!                       ║
╚════════════════════════════════════════════════════════════════╝

ALL TABLES & FUNCTIONS CREATED FRESH!

Next: Run FIX_ANONYMOUS_USERNAMES.sql
Then: Run INTEGRATE_MARKETPLACE_MESSAGING.sql

REFRESH YOUR PAGE AFTER ALL 3!
' as success_message;
