-- ========================================
-- CREATE ALL MISSING TABLES FOR SECURITY FIX (ULTRA SAFE VERSION)
-- ========================================
...
-- ========================================
-- STEP 6: CREATE ESCROW_TRANSACTIONS TABLE (WITH CORRECT COLUMN NAME)
-- ========================================
...
BEGIN
    ...
    -- Create indexes for escrow_transactions (check for buyer_id)
    ...
    -- Create indexes for stripe_bank_accounts
...
-- ========================================
-- STEP 12: ENABLE RLS ON ALL TABLES (ULTRA SAFE)
-- ========================================
DO $$
BEGIN
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'user_balances') THEN
...
BEGIN
    ...
    -- Create policies for escrow_transactions if it exists (handle buyer_id vs user_id)
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'escrow_transactions') THEN
        IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema = 'public' AND table_name = 'escrow_transactions' AND column_name = 'buyer_id') THEN
...
-- ========================================
-- STEP 14: GRANT PERMISSIONS (ULTRA SAFE)
-- ========================================
DO $$
BEGIN
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'user_balances') THEN
...
-- ========================================
-- STEP 16: CREATE UPDATE TRIGGERS (ULTRA SAFE)
-- ========================================
DO $$
BEGIN
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'user_balances') THEN
...
-- ========================================
-- STEP 18: SHOW COLUMN INFORMATION FOR ESCROW_TRANSACTIONS
-- ========================================
SELECT 
    column_name,
    data_type,
