-- SIMPLE_JOIN_FUNCTION.sql
-- This script creates a simple join function that works with existing database structure
...
-- Create a simple join function that works
...
-- Test the function
SELECT 'Simple join function created successfully!' as status;
