-- FIX TYPE CASTING ERROR IN JOIN_HOT_SELL_SESSION
...
BEGIN
  ...
  AND user_id = p_user_id::TEXT;  -- Cast to TEXT instead of UUID
  ...
  INSERT INTO public.fixed_game_participants (
    ...
    active_game_id, 
    p_user_id::TEXT,  -- Cast to TEXT instead of UUID
    p_entry_fee
...
-- Test the function
SELECT 'join_hot_sell_session function fixed with proper type casting!' as status;
