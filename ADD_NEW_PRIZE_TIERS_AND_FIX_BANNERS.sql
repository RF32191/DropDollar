-- ADD NEW PRIZE TIERS AND FIX ALL BANNERS
-- This adds $2 hot sell and $3 winner takes it all prizes
...
-- 2. Add $3 Winner Takes It All Prize
INSERT INTO public.fixed_games_config (
  id,
  game_type,
  tournament_type,
...
SET prize_pool = CASE 
  ...
  WHEN tournament_type = 'winner_takes_all' AND entry_fee = 1 THEN 300 -- $3 for 1 token winner takes all
  ELSE prize_pool
END
WHERE tournament_type IN ('hot_sell', 'winner_takes_all');

SELECT 'New prize tiers added and all banners fixed!' as status;
