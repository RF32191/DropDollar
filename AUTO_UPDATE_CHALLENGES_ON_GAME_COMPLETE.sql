...
-- NOTE: This function is now defined in UPDATE_CHALLENGES_FOR_COIN_PLAY.sql
-- with coin play support. This file keeps the trigger updated.
-- The function signature is:
-- update_challenges_on_game_complete(p_user_id UUID, p_game_type TEXT, p_score INTEGER, p_is_practice BOOLEAN, p_is_coin_play BOOLEAN DEFAULT false)
