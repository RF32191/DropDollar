...
export const sampleReviews: { [listingId: string]: Review[] } = {
  '1': [ // iPhone 15 Pro reviews
    {
      ...
      rating: 5,
      title: 'Won it for $450 - Every Dollar Drops the Price works!',
    ...
    },
    {
      ...
      content: 'This iPhone 15 Pro is in pristine condition! I won it for $520 after placing 12 bids. The seller was professional and shipped it the same day. Every dollar drops the price - I saved almost $500 compared to buying retail. Highly recommend Dollar Drop!',
      date: '2024-01-10',
      verified: true,
      helpful: 18,
      notHelpful: 1
  ...
  '2': [ // Gaming Laptop reviews
    ...
    },
    {
      ...
      content: 'As a computer science student, I needed a powerful laptop but couldn\'t afford retail prices. Dollar Drop made my dream possible! Won this beast for $680. Every dollar drops the price - I love this platform! Performance is incredible.',
      date: '2024-01-09',
      verified: true,
      helpful: 27,
      notHelpful: 1
  ...
  '5': [ // Designer Handbag reviews
    {
      ...
      content: 'I never thought I could afford a Louis Vuitton bag, but Dollar Drop made it possible! Won this Neverfull MM for $320 instead of $1,200. It\'s 100% authentic with all original packaging. Every dollar drops the price - I\'m obsessed with this platform!',
      date: '2024-01-16',
      verified: true,
      helpful: 33,
      notHelpful: 0
  ...
  '6': [ // Camera reviews
    {
      ...
      content: 'As a photography student, this Canon EOS R5 was out of my budget at $3,900. Won it for $1,100 on Dollar Drop! The image quality is phenomenal and it came with original warranty. Every dollar drops the price - this platform is a game-changer for students and professionals alike.',
      date: '2024-01-17',
      verified: true,
      helpful: 28,
      notHelpful: 1
