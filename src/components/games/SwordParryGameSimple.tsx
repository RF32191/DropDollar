          ...
          <div className="relative z-10">
            ...
            <div className="mb-6 w-full max-w-2xl mx-auto">
              <div 
                ...
                onClick={(e) => {
                  e.stopPropagation();
                  setExpandedVideo('/sword-parry-gameplay.mp4');
                }}
              >
                <video
                  autoPlay
        ...
        {expandedVideo && (
          ...
          >
            <div className="relative w-full max-w-6xl" style={{ aspectRatio: '16/9' }}>
              <button
                onClick={() => setExpandedVideo(null)}
                className="absolute -top-12 right-0 text-white text-4xl font-bold hover:text-red-400 transition-colors z-10"
              >
                ✕ Close
              </button>
              <video
                ...
                loop
                controls
                className="w-full h-full rounded-lg border-4 border-red-400 shadow-2xl"
                style={{ objectFit: 'contain' }}
