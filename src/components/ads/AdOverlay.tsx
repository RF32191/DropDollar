...
export default function AdOverlay({ 
  ...
  return (
    <div className="fixed inset-0 bg-black/90 flex items-center justify-center z-50 p-2 sm:p-4">
      <div 
        className={`relative w-full ${adSize.className}`}
        style={{ 
          maxWidth: deviceInfo.isMobile ? '95vw' : deviceInfo.isTablet ? '80vw' : '70vw',
          maxHeight: deviceInfo.isMobile ? '85vh' : '80vh'
        }}
      >
        {/* Ad Content Area */}
        <div className="bg-gradient-to-br from-gray-800 via-gray-900 to-black rounded-2xl p-3 sm:p-6 lg:p-8 shadow-2xl border border-gray-700 h-full overflow-y-auto">
          ...
          <div className="bg-gradient-to-br from-blue-900/20 via-purple-900/20 to-pink-900/20 rounded-xl p-4 sm:p-8 lg:p-12 text-center border border-gray-600">
            ...
            <div className="space-y-3 sm:space-y-6">
              ...
              {/* Fake Brand Elements - Responsive Grid */}
              {!deviceInfo.isMobile && (
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-6 mb-4 sm:mb-8">
                  <div className="bg-white/10 rounded-lg p-3 sm:p-4">
                    <div className="w-8 h-8 sm:w-12 sm:h-12 lg:w-16 lg:h-16 bg-gradient-to-br from-blue-500 to-purple-500 rounded-lg mx-auto mb-2 sm:mb-3"></div>
                    <div className="text-white font-medium text-xs sm:text-sm lg:text-base">Premium Gaming</div>
                    <div className="text-gray-400 text-xs sm:text-sm">Experience the best</div>
                  </div>
                  
                  <div className="bg-white/10 rounded-lg p-3 sm:p-4">
                    <div className="w-8 h-8 sm:w-12 sm:h-12 lg:w-16 lg:h-16 bg-gradient-to-br from-green-500 to-blue-500 rounded-lg mx-auto mb-2 sm:mb-3"></div>
                    <div className="text-white font-medium text-xs sm:text-sm lg:text-base">Skill Enhancement</div>
                    <div className="text-gray-400 text-xs sm:text-sm">Level up your game</div>
                  </div>
                  
                  <div className="bg-white/10 rounded-lg p-3 sm:p-4">
                    <div className="w-8 h-8 sm:w-12 sm:h-12 lg:w-16 lg:h-16 bg-gradient-to-br from-purple-500 to-pink-500 rounded-lg mx-auto mb-2 sm:mb-3"></div>
                    <div className="text-white font-medium text-xs sm:text-sm lg:text-base">Win More</div>
                    <div className="text-gray-400 text-xs sm:text-sm">Increase your odds</div>
                  </div>
                </div>
              )}
