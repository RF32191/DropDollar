...
const OneShotArenaGame = dynamic(
  () => import('@/components/games/OneShotArenaGame'),
  { 
    ssr: false,
    loading: () => (
      <div className="w-full h-[600px] bg-gray-900 rounded-xl flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-400">Loading One Shot Arena...</p>
        </div>
      </div>
    )
  }
...
export default function OneShotArenaPage() {
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">One projectile. Make it count!</p>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              ...
              <p className="text-gray-400 text-sm">
                You get ONE shot per round to hit the targets! Aim carefully, 
                use ricochets off walls, and hit the bullseye for maximum points.
              </p>
            </div>
            <div>
              ...
              <ul className="text-gray-400 text-sm space-y-1">
                ...
                <li>• <strong>Scroll:</strong> Adjust power</li>
                <li>• <strong>Click/SPACE:</strong> Fire!</li>
                <li>• <strong>Mobile:</strong> Drag to aim, release to fire</li>
              </ul>
            </div>
            <div>
              <h3 className="font-semibold text-green-400 mb-2">⚡ Scoring</h3>
              <ul className="text-gray-400 text-sm space-y-1">
                <li>• Target hit: 100-400 points (size based)</li>
                <li>• Perfect center: 2x multiplier!</li>
                <li>• Each ricochet: +50 bonus</li>
                <li>• Clear all targets: +500 bonus</li>
              </ul>
            </div>
            <div>
              <h3 className="font-semibold text-purple-400 mb-2">🏆 Strategy</h3>
              <ul className="text-gray-400 text-sm space-y-1">
                <li>• Bank shots off walls = big points</li>
                <li>• Smaller targets = more points</li>
                <li>• 10 rounds total - same layout for all</li>
              </ul>
            </div>
          </div>
        </div>
