...
export default function GamesPage() {
  ...
  return (
    <>
      ...
      {/* Site Theme Overlay - Carnival for Halloween, Toyshop for Christmas */}
      <PageThemeOverlay page="games" />
              ...
              <div key={game.id} className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all border border-gray-200 light-reflection group">
                ...
                <div className="h-40 bg-gradient-to-br from-blue-500 to-purple-600 relative overflow-hidden">
                  ...
                  {game.id === 'penny-passer' && (
                    <div className="absolute inset-0">
                      <LazyVideo src="/PennyPasser.mp4" className="w-full h-full" preload="none" />
                    </div>
                  )}
                  ...
                  {game.id === 'lightning-maze' && (
                    <div className="absolute inset-0">
                      <LazyVideo src="/lighteningmaze.mp4" className="w-full h-full" preload="none" />
                    </div>
                  )}
                  
                  {game.id === 'parry-pro' && (
                    <div className="absolute inset-0">
                      <LazyVideo src="/ParryPro.mp4" className="w-full h-full" preload="none" />
                    </div>
                  )}
                  
                  {game.id === 'neon-striker' && (
                    <div className="absolute inset-0">
                      <LazyVideo src="/NeonStriker.mp4" className="w-full h-full" preload="none" />
                    </div>
                  )}
