              ...
              <div key={game.id} className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all border border-gray-200">
                ...
                <div className="h-40 bg-gradient-to-br from-blue-500 to-purple-600 relative overflow-hidden">
                  ...
                  {game.id === 'penny-passer' && (
                    <div className="absolute inset-0 flex items-center justify-center">
                      {/* Penny Passer animation - Frogger style with penny and hands */}
                      <div className="relative w-full h-full">
                        {/* Lane lines */}
                        <div className="absolute inset-0 flex flex-col justify-between py-4">
                          <div className="h-px bg-yellow-400 opacity-50"></div>
                          <div className="h-px bg-yellow-400 opacity-50"></div>
                          <div className="h-px bg-yellow-400 opacity-50"></div>
                          <div className="h-px bg-yellow-400 opacity-50"></div>
                        </div>
                        
                        {/* Penny (player) moving upward */}
                        <div className="absolute text-4xl animate-bounce"
                             style={{
                               bottom: '20%',
                               left: '50%',
                        ...
                        {/* Moving hands (obstacles) - lane 1 moving right */}
                        ...
                        {/* Moving hands - lane 2 moving left */}
                        <div className="absolute text-3xl"
                             style={{
                               top: '40%',
                               right: '0%',
                               animation: 'slideLeft 2.5s infinite linear',
                               animationDelay: '0.5s'
                             }}>✋</div>
                        
                        {/* Moving hands - lane 3 moving right */}
                        <div className="absolute text-3xl"
                             style={{
                               top: '60%',
                        ...
                        <div className="absolute flex gap-1"
                          ...
                          <div className="text-sm animate-pulse" style={{animationDelay: '0.3s'}}>❤️</div>
                          <div className="text-sm animate-pulse" style={{animationDelay: '0.6s'}}>❤️</div>
                        </div>
                        
                        {/* Timer */}
                        <div className="absolute text-sm animate-pulse"
                             style={{
                               top: '10%',
                               right: '10%'
                             }}>⏱️</div>
