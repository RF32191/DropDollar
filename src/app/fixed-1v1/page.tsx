...
export default function Fixed1v1Page() {
  ...
  const loadFixedGamesData = async () => {
    try {
      ...
      const games = await FixedGamesService.getActiveFixedGames('1v1');
      setFixedGames(games);
      
      // Load game configs
      const configs = await FixedGamesService.getFixedGameConfigs('1v1');
      ...
      console.error('❌ [Fixed1v1] Error loading data:', error);
    } finally {
      setIsLoading(false);
    }
  };
  ...
  const checkUserEligibility = async () => {
    ...
    try {
      ...
      console.error('❌ [Fixed1v1] Error checking eligibility:', error);
    }
  };
  ...
  const joinFixedGame = async (game: ActiveFixedGame, config: FixedGameConfig) => {
    ...
    try {
      ...
      console.error('❌ [Fixed1v1] Error joining game:', error);
  ...
  const createFixedGame = async (formData: any) => {
    try {
      ...
      if (result) {
        setMessage({ type: 'success', text: 'Fixed 1v1 game created successfully!' });
      ...
      console.error('❌ [Fixed1v1] Error creating game:', error);
  ...
  const calculatePrizeDistribution = (prizePool: number) => {
    return FixedGamesService.calculatePrizeDistribution(prizePool, '1v1');
  };
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-purple-900 text-white">
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="flex items-center justify-center h-64">
            ...
            <span className="ml-4 text-lg">Loading fixed 1v1 tournaments...</span>
          </div>
        </div>
      </div>
    );
      ...
      <div className="container mx-auto px-4 py-8 relative z-10">
        ...
        <div className="mb-8 text-center">
          <div className="flex items-center justify-center mb-4">
            <TrophyIcon className="w-12 h-12 text-blue-500 mr-4 animate-pulse" />
            <h1 className="text-5xl font-bold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">
              FIXED 1V1
            </h1>
          </div>
          <p className="text-xl text-gray-300 mb-2">Head-to-head tournaments with guaranteed prizes</p>
          <p className="text-lg text-gray-400">Fixed 1v1 games with consistent rules and prize pools</p>
          ...
          <div className="mb-8 text-center">
            ...
            >
              <div className="flex items-center">
                ...
                {showCreateForm ? 'Cancel' : 'Create Fixed 1v1 Game'}
              </div>
            </button>
          </div>
        )}
        ...
        {showCreateForm && (
          <div className="mb-8 max-w-2xl mx-auto">
            <div className="bg-white/10 backdrop-blur-xl rounded-3xl p-8 border border-white/20">
              <h3 className="text-2xl font-bold text-white mb-6 text-center">Create Fixed 1v1 Game</h3>
              <form onSubmit={(e) => {
                e.preventDefault();
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
                    placeholder="Describe your 1v1 tournament..."
                  />
                </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {fixedGames.map((game) => {
            ...
            const canJoin = userTokens >= config.entry_fee && !isJoined && gameParticipants.length < 2;
              ...
              <div key={game.id} className="bg-white/10 backdrop-blur-xl rounded-3xl p-8 border border-white/20 hover:bg-white/15 transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                ...
                <div className="mb-6">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="flex items-center bg-blue-500/20 rounded-full px-4 py-2">
                      ...
                      <span className="text-blue-300 font-semibold">1V1</span>
                    </div>
                  </div>
                  ...
                  <div className="bg-gradient-to-r from-blue-500 to-purple-500 rounded-2xl p-6 mb-6">
                    <div className="text-center">
                      <p className="text-blue-100 text-sm font-medium mb-2">FIXED PRIZE POOL</p>
                      <p className="text-4xl font-bold text-white">{formatPrizeAmount(config.prize_pool)}</p>
                      <p className="text-blue-100 text-sm mt-2">(15% fee deducted from prizes)</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="mb-6 space-y-3">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-white font-semibold">{gameParticipants.length}/2</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                    ...
                    <div className="bg-red-500/20 border border-red-500/50 rounded-xl p-4">
                      <p className="text-red-300">
                        {userTokens < config.entry_fee 
                          ...
                          : 'Tournament is full (2/2 players)'
                        }
                      </p>
                    </div>
                  ) : (
                    ...
                    >
                      {joiningGame === game.id ? (
                        ...
                        <div className="flex items-center justify-center">
                          ...
                          JOIN 1V1 GAME - {config.entry_fee} TOKENS
                        </div>
                      )}
                    </button>
                  )}
        ...
        {fixedGames.length === 0 && (
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-semibold text-gray-300 mb-2">No Fixed 1v1 Games Available</h3>
            <p className="text-gray-400">Create your first fixed 1v1 tournament!</p>
          </div>
        )}
      </div>
    </div>
