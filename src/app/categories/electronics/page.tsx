      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-600">
            Latest tech gadgets and electronic devices - Enter games to win at fractional token prices!
          </p>
        </div>
        ...
        <div>
          <h2 className="text-3xl font-bold text-gray-900 mb-6">📱 All Electronics Listings</h2>
