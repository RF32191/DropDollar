...
export default function CoinPlayPage() {
  ...
  const handleJoinSession = async (configId: string) => {
    ...
    const isMobileCompatible = MOBILE_COMPATIBLE_GAMES.includes(session.game_type);
    const isDesktopOnly = DESKTOP_ONLY_GAMES.includes(session.game_type);
    ...
    <>
      ...
      <ErrorBoundary>
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none z-0" id="coins-container" style={{ zIndex: 0 }}>
          {/* Coins will be generated by useEffect */}
        </div>
        ...
        {/* Main Content */}
        <div className="max-w-7xl mx-auto px-4 py-8 pb-24 relative z-10">
          {/* Hero Section */}
