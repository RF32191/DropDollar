...
export default function CoinPlayPage() {
  ...
  return (
    <>
      ...
      <ErrorBoundary>
        <div className="min-h-screen bg-gradient-to-br from-amber-900 via-orange-800 to-amber-900 relative overflow-hidden">
        {/* Falling Gold Coins Animation */}
        <div className="absolute inset-0 overflow-hidden pointer-events-none" id="coins-container">
