  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-orange-800 via-red-800 to-orange-800 text-white relative overflow-hidden">
        ...
        <div className="fixed inset-0 overflow-visible pointer-events-none" id="stars-container-red" style={{ zIndex: 0 }}>
          {/* Stars will be generated by useEffect */}
        </div>
        
        {/* Animated Red/Amber Ember Glow Background - Same style as games page */}
        <div className="fixed inset-0 overflow-hidden pointer-events-none" style={{ zIndex: 0 }}>
          <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-red-500/40 rounded-full blur-3xl animate-pulse"></div>
          <div className="absolute top-1/2 right-1/4 w-80 h-80 bg-orange-500/35 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
          ...
          <div className="absolute top-1/3 right-1/3 w-64 h-64 bg-amber-500/30 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '0.5s' }}></div>
          <div className="absolute bottom-1/3 left-1/6 w-88 h-88 bg-orange-600/35 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1.5s' }}></div>
          ...
          <div className="absolute top-1/6 left-1/3 w-68 h-68 bg-amber-600/35 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '3s' }}></div>
          <div className="absolute bottom-1/6 right-1/4 w-84 h-84 bg-orange-500/30 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '0.75s' }}></div>
        </div>
