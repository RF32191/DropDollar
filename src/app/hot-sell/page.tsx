...
export default function HotSellPage() {
  ...
  // Generate Red/Amber Scrolling Stars - Travel all the way up
  useEffect(() => {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-orange-800 via-red-800 to-orange-800 text-white relative overflow-hidden">
        {/* Red/Amber Scrolling Stars Background - Travel all the way up to navigation */}
        <div className="fixed inset-0 overflow-visible pointer-events-none" id="stars-container-red" style={{ zIndex: 1, top: 0, left: 0, right: 0, bottom: 0 }}>
