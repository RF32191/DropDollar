            ...
            <div className="flex items-center justify-center flex-1 mx-4">
              <nav className="hidden lg:flex items-center space-x-4">
                <div className="flex items-center space-x-2">
                  ...
                  <Link href="/how-it-works" className="relative group px-2 py-2 text-orange-200 hover:text-white font-medium transition-all duration-300 text-sm">
                    How It Works
                  </Link>
                </div>
      ...
      <div className="max-w-full mx-auto px-2 sm:px-4 lg:px-6 py-16 bg-gradient-to-br from-gray-50 to-orange-50 dark:from-gray-900 dark:to-red-950 transition-colors">
        <section className="mb-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 w-full">
            {/* $10 Micro Tournament */}
            <div className="bg-gradient-to-br from-yellow-500 via-yellow-600 to-amber-600 rounded-3xl p-6 shadow-2xl border-2 border-yellow-400/50 hover:scale-105 transition-all duration-300">
              <div className="text-center text-white">
                <div className="text-4xl mb-4">💰</div>
                <h3 className="text-xl font-bold mb-2">$10 Micro Tournament</h3>
                <div className="text-2xl font-black text-yellow-200 mb-2">Prize: $10</div>
                <div className="text-sm mb-4">Multi-Target Reaction</div>
                
                {/* Entry Amount Selector */}
                <div className="mb-4">
                  <div className="flex space-x-1">
                    <button className="flex-1 py-2 px-2 rounded-lg font-medium bg-yellow-600 text-white text-xs">
                      <div>$1</div>
                    </button>
                    <button className="flex-1 py-2 px-2 rounded-lg font-medium bg-gray-100 text-gray-700 hover:bg-gray-200 text-xs">
                      <div>$2</div>
                    </button>
                    <button className="flex-1 py-2 px-2 rounded-lg font-medium bg-gray-100 text-gray-700 hover:bg-gray-200 text-xs">
                      <div>$3</div>
                ...
                <button className="w-full bg-white/20 hover:bg-white/30 text-white font-bold py-3 rounded-lg transition-colors">
                  🪙 Enter with $1
                </button>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-green-500 via-green-600 to-emerald-600 rounded-3xl p-6 shadow-2xl border-2 border-green-400/50 hover:scale-105 transition-all duration-300">
              <div className="text-center text-white">
                <div className="text-4xl mb-4">💚</div>
                <h3 className="text-xl font-bold mb-2">$100 Standard Tournament</h3>
                <div className="text-2xl font-black text-green-200 mb-2">Prize: $100</div>
                <div className="text-sm mb-4">Falling Object Catch</div>
                
                {/* Entry Amount Selector */}
                <div className="mb-4">
                  <div className="flex space-x-1">
                    <button className="flex-1 py-2 px-2 rounded-lg font-medium bg-green-600 text-white text-xs">
                      <div>$1</div>
                    </button>
                    <button className="flex-1 py-2 px-2 rounded-lg font-medium bg-gray-100 text-gray-700 hover:bg-gray-200 text-xs">
                      <div>$2</div>
            ...
            <div className="bg-gradient-to-br from-blue-500 via-blue-600 to-indigo-600 rounded-3xl p-6 shadow-2xl border-2 border-blue-400/50 hover:scale-105 transition-all duration-300">
              <div className="text-center text-white">
                <div className="text-4xl mb-4">💙</div>
                <h3 className="text-xl font-bold mb-2">$500 Premium Tournament</h3>
                <div className="text-2xl font-black text-blue-200 mb-2">Prize: $500</div>
                <div className="text-sm mb-4">Color Sequence Memory</div>
                
                {/* Entry Amount Selector */}
                <div className="mb-4">
                  <div className="flex space-x-1">
                    <button className="flex-1 py-2 px-2 rounded-lg font-medium bg-blue-600 text-white text-xs">
                      <div>$1</div>
                    </button>
                    <button className="flex-1 py-2 px-2 rounded-lg font-medium bg-gray-100 text-gray-700 hover:bg-gray-200 text-xs">
                      <div>$2</div>
            ...
            <div className="bg-gradient-to-br from-purple-500 via-purple-600 to-violet-600 rounded-3xl p-6 shadow-2xl border-2 border-purple-400/50 hover:scale-105 transition-all duration-300">
              <div className="text-center text-white">
                <div className="text-4xl mb-4">💜</div>
                <h3 className="text-xl font-bold mb-2">$2500 Advanced Tournament</h3>
                <div className="text-2xl font-black text-purple-200 mb-2">Prize: $2500</div>
                <div className="text-sm mb-4">Multi-Target Reaction</div>
                
                {/* Entry Amount Selector */}
                <div className="mb-4">
                  <div className="flex space-x-1">
                    <button className="flex-1 py-2 px-2 rounded-lg font-medium bg-purple-600 text-white text-xs">
                      <div>$1</div>
                    </button>
                    <button className="flex-1 py-2 px-2 rounded-lg font-medium bg-gray-100 text-gray-700 hover:bg-gray-200 text-xs">
                      <div>$2</div>
            ...
            <div className="bg-gradient-to-br from-red-500 via-red-600 to-rose-600 rounded-3xl p-6 shadow-2xl border-2 border-red-400/50 hover:scale-105 transition-all duration-300">
              <div className="text-center text-white">
                <div className="text-4xl mb-4">❤️</div>
                <h3 className="text-xl font-bold mb-2">$25000 Elite Championship</h3>
                <div className="text-2xl font-black text-red-200 mb-2">Prize: $25000</div>
                <div className="text-sm mb-4">Falling Objects Catch</div>
                
                {/* Entry Amount Selector */}
                <div className="mb-4">
                  <div className="flex space-x-1">
                    <button className="flex-1 py-2 px-2 rounded-lg font-medium bg-red-600 text-white text-xs">
                      <div>$1</div>
                    </button>
                    <button className="flex-1 py-2 px-2 rounded-lg font-medium bg-gray-100 text-gray-700 hover:bg-gray-200 text-xs">
                      <div>$2</div>
