...
DROP FUNCTION IF EXISTS create_hot_sell_listing(TEXT, TEXT, TEXT, INTEGER, DECIMAL, INTEGER, TEXT);
DROP FUNCTION IF EXISTS join_hot_sell_listing(TEXT, TEXT, INTEGER);
DROP FUNCTION IF EXISTS create_group_battle(TEXT, TEXT, INTEGER, DECIMAL, TEXT);
DROP FUNCTION IF EXISTS join_group_battle(TEXT, TEXT, INTEGER);
DROP FUNCTION IF EXISTS create_physical_listing(TEXT, TEXT, TEXT, INTEGER, TEXT, TEXT);
DROP FUNCTION IF EXISTS join_physical_listing(TEXT, TEXT, INTEGER);
...
DROP TABLE IF EXISTS public.hot_sell_participants CASCADE;
...
DROP TABLE IF EXISTS public.physical_listing_participants CASCADE;
