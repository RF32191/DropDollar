-- ============================================================================
-- CREATE MISSING SESSIONS (SEPARATE - different columns per table)
-- ============================================================================
-- Winner Takes All and Hot Sell have different schemas
-- ============================================================================

-- ============================================================================
-- 1. CREATE MISSING WINNER TAKES ALL SESSIONS (minimal columns)
-- ============================================================================
...
-- ============================================================================
-- 2. CREATE MISSING HOT SELL SESSIONS (includes max_participants)
-- ============================================================================
...
-- Show samples (different columns for each)
...
SELECT id, config_id, status, current_pool, base_price, participants_count, max_participants
FROM public.hot_sell_sessions 
WHERE status = 'active'
ORDER BY created_at DESC 
LIMIT 5;
...
-- ============================================================================
-- RESULT: 
-- - Winner Takes All: NO max_participants
-- - Hot Sell: HAS max_participants
-- - Both use current_pool
-- ============================================================================
