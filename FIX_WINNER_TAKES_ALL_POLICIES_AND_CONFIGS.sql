-- Fix Winner Takes It All SQL Functions and Create Configurations
-- This script handles existing policies and creates Winner Takes It All configs
...
-- Recreate RLS Policies for winner_takes_all_sessions
...
-- Recreate RLS Policies for winner_takes_all_participants
...
-- Test creating a session for the $2 Winner Takes It All
DO $$
DECLARE
    config_id UUID;
    session_id UUID;
