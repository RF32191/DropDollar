...
-- SWORD PARRY (Destroy red attacks with precise slashes)
...
-- BLADE BOUNCE (Mouse-controlled sword defense)
...
-- LASER DODGE EXTREME (Full-screen laser grids)
...
-- MULTI-TARGET REACTION (Click highlighted targets fast)
...
-- FALLING OBJECT CATCH (Catch coins with cash case)
...
-- COLOR SEQUENCE MEMORY (Audio-visual memory game)
...
-- CASH STACK CHALLENGE (Stack coins on falling 3D cash)
...
-- QUICK CLICK (Lightning-fast reaction test)
...
BEGIN
  ...
  RAISE NOTICE '💵 Price range: $3 to $10,000';
  RAISE NOTICE '⏱️  No timers - games complete when max participants reached';
  RAISE NOTICE '';
  RAISE NOTICE '🎯 Games included:';
  RAISE NOTICE '  • Sword Slash (5 tiers)';
  RAISE NOTICE '  • Blade Bounce (4 tiers)';
  RAISE NOTICE '  • Laser Dodge (5 tiers)';
  RAISE NOTICE '  • Multi-Target (4 tiers)';
  RAISE NOTICE '  • Coin Catch (4 tiers)';
  RAISE NOTICE '  • Color Memory (4 tiers)';
  RAISE NOTICE '  • Cash Stack (4 tiers)';
  RAISE NOTICE '  • Quick Click (4 tiers)';
END $$;
