-- ============================================================================
-- CREATE ALL MISSING CONFIGS AND SESSIONS
-- ============================================================================
-- This creates all the configs that the pages expect, then creates sessions
-- ============================================================================

-- PART 1: Create Winner Takes All Configs
INSERT INTO winner_takes_all_configs (id, game_type, title, description, entry_fee, base_price, game_duration, rng_seed, created_at, updated_at)
VALUES
('wta-2-sword-parry', 'sword_parry', '$2 Winner Takes It All - Sword Parry', 'Winner takes the entire $2 prize pool!', 1, 2, 30, 5, NOW(), NOW()),
('wta-5-blade-bounce', 'blade_bounce', '$5 Winner Takes It All - Blade Bounce', 'Winner takes the entire $5 prize pool!', 1, 5, 45, 6, NOW(), NOW()),
('wta-10-laser-dodge', 'laser_dodge', '$10 Winner Takes It All - Laser Dodge', 'Winner takes the entire $10 prize pool!', 1, 10, 60, 7, NOW(), NOW()),
('wta-25-multi-target', 'multi_target_reaction', '$25 Winner Takes It All - Multi Target', 'Winner takes the entire $25 prize pool!', 1, 25, 90, 8, NOW(), NOW()),
('wta-50-sword-parry', 'sword_parry', '$50 Winner Takes It All - Sword Parry', 'Winner takes the entire $50 prize pool!', 1, 50, 120, 9, NOW(), NOW()),
('wta-100-blade-bounce', 'blade_bounce', '$100 Winner Takes It All - Blade Bounce', 'Winner takes the entire $100 prize pool!', 1, 100, 150, 10, NOW(), NOW()),
('wta-250-laser-dodge', 'laser_dodge', '$250 Winner Takes It All - Laser Dodge', 'Winner takes the entire $250 prize pool!', 1, 250, 180, 11, NOW(), NOW()),
('wta-500-multi-target', 'multi_target_reaction', '$500 Winner Takes It All - Multi Target', 'Winner takes the entire $500 prize pool!', 1, 500, 240, 12, NOW(), NOW()),
('wta-1000-falling-object', 'falling_object', '$1000 Winner Takes It All - Falling Object', 'Winner takes the entire $1000 prize pool!', 1, 1000, 300, 13, NOW(), NOW()),
('wta-2500-color-sequence', 'color_sequence', '$2500 Winner Takes It All - Color Sequence', 'Winner takes the entire $2500 prize pool!', 1, 2500, 360, 14, NOW(), NOW()),
('wta-10000-laser-dodge', 'laser_dodge', '$10000 Winner Takes It All - Laser Dodge', 'Winner takes the entire $10000 prize pool!', 1, 10000, 420, 15, NOW(), NOW()),
('wta-25000-multi-target', 'multi_target_reaction', '$25000 Winner Takes It All - Multi Target', 'Winner takes the entire $25000 prize pool!', 1, 25000, 480, 16, NOW(), NOW())
ON CONFLICT (id) DO NOTHING;

-- PART 2: Create Hot Sell Configs
...
-- PART 3: Create sessions for all configs
...
BEGIN
    ...
    RAISE NOTICE '';
    RAISE NOTICE '✅ CONFIGS AND SESSIONS CREATED';
    ...
    IF wta_configs = wta_sessions AND hs_configs = hs_sessions THEN
        RAISE NOTICE '✅ ALL SESSIONS CREATED - PAGES WILL NOW LOAD!';
    END IF;
END $$;

SELECT 'WINNER TAKES ALL SESSIONS' as type, config_id, status FROM winner_takes_all_sessions ORDER BY config_id;
SELECT 'HOT SELL SESSIONS' as type, config_id, status FROM hot_sell_sessions ORDER BY config_id;
