...
-- ============================================================================
-- 11. CREATE DEFAULT DAILY CHALLENGES
-- ============================================================================

-- Insert default daily challenges (will be created daily by a cron job or manually)
...
VALUES 
    (CURRENT_DATE, 'play_practice', 'Practice Makes Perfect', 'Play 3 practice games today', 3, 25, 5, true),
    (CURRENT_DATE, 'play_competition', 'Competitive Spirit', 'Play 2 competition games today', 2, 50, 10, true),
    (CURRENT_DATE, 'score_threshold', 'Score Master', 'Score 1000+ points in any game', 1, 30, 7, true),
    (CURRENT_DATE, 'games_count', 'Game Marathon', 'Play 5 games total today', 5, 40, 8, true)
