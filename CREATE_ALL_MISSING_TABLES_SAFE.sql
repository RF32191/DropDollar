-- ========================================
-- CREATE ALL MISSING TABLES FOR SECURITY FIX (SAFE VERSION)
-- ========================================
...
-- ========================================
-- STEP 2: CREATE USER_BALANCES TABLE
-- ========================================
...
-- ========================================
-- STEP 3: CREATE USER_LEVELS TABLE
-- ========================================
...
-- ========================================
-- STEP 5: CREATE GAME_SESSIONS TABLE
-- ========================================
...
-- ========================================
-- STEP 6: CREATE ESCROW_TRANSACTIONS TABLE
-- ========================================
...
-- ========================================
-- STEP 7: CREATE USER_BANK_ACCOUNTS TABLE
-- ========================================
...
-- ========================================
-- STEP 8: CREATE SELLER_PAYOUTS TABLE
-- ========================================
...
-- ========================================
-- STEP 9: CREATE STRIPE_BANK_ACCOUNTS TABLE
-- ========================================
...
-- ========================================
-- STEP 10: CREATE WITHDRAWAL_REQUESTS TABLE
-- ========================================
...
-- ========================================
-- STEP 11: CREATE INDEXES FOR ALL TABLES (SAFE)
-- ========================================
-- Only create indexes if the tables exist and have the columns
DO $$
BEGIN
    -- Create indexes for user_balances if it exists
    ...
    -- Create indexes for user_levels if it exists
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'user_levels') THEN
        IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema = 'public' AND table_name = 'user_levels' AND column_name = 'user_id') THEN
            CREATE INDEX IF NOT EXISTS idx_user_levels_user_id ON public.user_levels (user_id);
        END IF;
    END IF;

    -- Create indexes for payment_transactions if it exists
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'payment_transactions') THEN
        IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema = 'public' AND table_name = 'payment_transactions' AND column_name = 'user_id') THEN
            CREATE INDEX IF NOT EXISTS idx_payment_transactions_user_id ON public.payment_transactions (user_id);
        END IF;
    END IF;

    -- Create indexes for game_sessions if it exists
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'game_sessions') THEN
        IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema = 'public' AND table_name = 'game_sessions' AND column_name = 'user_id') THEN
            CREATE INDEX IF NOT EXISTS idx_game_sessions_user_id ON public.game_sessions (user_id);
        END IF;
    END IF;

    -- Create indexes for escrow_transactions if it exists
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'escrow_transactions') THEN
        IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema = 'public' AND table_name = 'escrow_transactions' AND column_name = 'user_id') THEN
            CREATE INDEX IF NOT EXISTS idx_escrow_transactions_user_id ON public.escrow_transactions (user_id);
        END IF;
    END IF;

    -- Create indexes for user_bank_accounts if it exists
    ...
    -- Create indexes for seller_payouts if it exists
    ...
    -- Create indexes for stripe_bank_accounts if it exists
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'stripe_bank_accounts') THEN
        IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema = 'public' AND table_name = 'stripe_bank_accounts' AND column_name = 'user_id') THEN
            CREATE INDEX IF NOT EXISTS idx_stripe_bank_accounts_user_id ON public.stripe_bank_accounts (user_id);
        END IF;
    END IF;

    -- Create indexes for withdrawal_requests if it exists
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'withdrawal_requests') THEN
        IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema = 'public' AND table_name = 'withdrawal_requests' AND column_name = 'user_id') THEN
            CREATE INDEX IF NOT EXISTS idx_withdrawal_requests_user_id ON public.withdrawal_requests (user_id);
        END IF;
    END IF;

    RAISE NOTICE 'Indexes created for all existing tables';
END $$;

-- ========================================
-- STEP 12: ENABLE RLS ON ALL TABLES (SAFE)
-- ========================================
DO $$
BEGIN
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'user_balances') THEN
...
-- ========================================
-- STEP 13: CREATE BASIC POLICIES FOR ALL TABLES (SAFE)
-- ========================================
DO $$
BEGIN
    ...
    -- Create policies for user_levels if it exists
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'user_levels') THEN
    ...
    -- Create policies for payment_transactions if it exists
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'payment_transactions') THEN
    ...
    -- Create policies for game_sessions if it exists
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'game_sessions') THEN
    ...
    -- Create policies for escrow_transactions if it exists
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'escrow_transactions') THEN
    ...
    -- Create policies for user_bank_accounts if it exists
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'user_bank_accounts') THEN
    ...
    -- Create policies for seller_payouts if it exists
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'seller_payouts') THEN
    ...
    -- Create policies for stripe_bank_accounts if it exists
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'stripe_bank_accounts') THEN
    ...
    -- Create policies for withdrawal_requests if it exists
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'withdrawal_requests') THEN
    ...
    RAISE NOTICE 'Policies created for all existing tables';
END $$;

-- ========================================
-- STEP 14: GRANT PERMISSIONS (SAFE)
-- ========================================
DO $$
BEGIN
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'user_balances') THEN
    ...
    RAISE NOTICE 'Permissions granted for all existing tables';
END $$;

-- ========================================
-- STEP 15: CREATE UPDATE TRIGGER FUNCTION
-- ========================================
...
-- ========================================
-- STEP 16: CREATE UPDATE TRIGGERS (SAFE)
-- ========================================
DO $$
BEGIN
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'user_balances') THEN
    ...
    RAISE NOTICE 'Triggers created for all existing tables';
END $$;
