-- Fix timer not starting issue

-- Ensure the join function exists and works
...
BEGIN
    ...
    -- Determine new status and timer
    ...
    RETURN jsonb_build_object(
        ...
        'timer_started', CASE WHEN new_pot >= session_record.base_price THEN true ELSE false END
    );
END;
$$;
