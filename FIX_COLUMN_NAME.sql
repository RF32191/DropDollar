-- ============================================
-- 🔧 FIX: Add Missing reaction_time_ms Column
-- ============================================
-- Error: "column \"reaction_time_ms\" of relation \"game_audit_log\" does not exist"
-- ============================================

-- Step 1: Add the missing column
ALTER TABLE game_audit_log 
ADD COLUMN IF NOT EXISTS reaction_time_ms NUMERIC;
...
BEGIN
    ...
    -- Insert the audit log with correct column name
    INSERT INTO game_audit_log (
        ...
        score,
        accuracy,
        reaction_time_ms,  -- Correct column name
        duration_seconds,
        cheat_score,
        score_rating,
        threat_level,
...
-- Verify table has the column now
SELECT column_name, data_type 
FROM information_schema.columns 
WHERE table_name = 'game_audit_log' 
  AND column_name IN ('reaction_time_ms', 'reaction_time', 'score', 'accuracy');
...
-- ============================================
-- ✅ EXPECTED: 
-- 1. Column reaction_time_ms should now exist
-- 2. Test insert should succeed
-- 3. You should see the test record in results
-- ============================================
