-- FIX_JOIN_WINNER_TAKES_ALL_SESSION_FUNCTION.sql
-- This script fixes the join_winner_takes_all_session function
-- that was causing "column base_price does not exist" errors

-- Drop and recreate the join_winner_takes_all_session function with proper base_price handling
...
DECLARE
    ...
    result JSON;
BEGIN
    -- Get session info including base_price
...
WHERE routine_name = 'join_winner_takes_all_session' 
